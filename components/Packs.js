      ...
      <div>
        ...
        <Row type='flex' justify='center'>
          <Form
            ...
            >
            <div style={styles.formTitle}>Add a new Blowouts Package Option</div>
            <FormItem
            ...
            <FormItem
              label='Price for the package '>
              <Input id='price' {...priceProps} />
            </FormItem>
            <FormItem
              label='Savings descriptive text '>
              <Input id='savings' {...savingsProps} />
            </FormItem>
            <FormItem
              label='How long is the package valid (in days)：'>
